...
- Haber completado el **Nivel 2** en la misma región (ej.: **us-east-1**).
...
> CloudShell por defecto. Comandos con `--region us-east-1` **explícito**. En N0–N4 **no** uses funciones, pipes avanzados ni `--query`. Copia IDs/DNS manualmente como `<PLACEHOLDER>`.
...
aws ec2 delete-vpc-endpoints --vpc-endpoint-ids <VPCE_ID> --region us-east-1
aws ec2 delete-vpc-endpoint-service-configurations --service-ids <ESVC_ID> --region us-east-1
...
# 3) Backend y SGs
aws ec2 terminate-instances --instance-ids <INSTANCE_SVC_ID> --region us-east-1
aws ec2 delete-security-group --group-id <SG_SVC_ID> --region us-east-1
aws ec2 delete-security-group --group-id <SG_EP_ID> --region us-east-1

# 4) Red de VPC-Servicios
aws ec2 disassociate-route-table --association-id <RT_SVC_PUB_ASSOC_ID> --region us-east-1
aws ec2 delete-route-table --route-table-id <RT_SVC_PUB_ID> --region us-east-1
aws ec2 detach-internet-gateway --internet-gateway-id <IGW_SVC_ID> --vpc-id <VPC_SVC_ID> --region us-east-1
aws ec2 delete-internet-gateway --internet-gateway-id <IGW_SVC_ID> --region us-east-1
aws ec2 delete-subnet --subnet-id <SUBNET_SVC_ID> --region us-east-1
aws ec2 delete-vpc --vpc-id <VPC_SVC_ID> --region us-east-1
