...
```mermaid
flowchart LR
  %% Diagrama: Flujo de seguridad en AWS (horizontal, compatible con GitHub)
  ...
  C["🛡️ **Subred / NACL**<br>Nivel de subred<br>Stateless<br>Permite o deniega tráfico<br>Reglas ordenadas por número"] --> 
