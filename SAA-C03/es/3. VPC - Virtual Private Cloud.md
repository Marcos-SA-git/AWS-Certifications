...
- El emparejamiento no permite el tráfico transitivo, es decir, debe haber emparejamiento **directo** entre VPCs para poder hacer llegar el tráfico hasta otro VPC por más que haya otras VPCs que podrian hacer de intermediarias. (Véase el Esquema 2)
